    ...
    page.innerHTML = `
      <div class="login-page">
        <div class="login-card">
          ...
          <button class="btn btn-primary w-full btn-lg" onclick="Pages._handleAuth()" style="margin-bottom: 1rem;">
            ${isSignIn ? 'Sign In' : 'Create Account'}
          </button>

          <div style="text-align: center; margin-bottom: 1rem; color: var(--muted); font-size: 0.875rem;">OR</div>

          <button class="btn btn-outline w-full btn-lg" onclick="Pages._handleGoogleLogin()" style="display: flex; align-items: center; justify-content: center; gap: 0.5rem; background: var(--bg-card);">
